...
_lr_signature = 'CAA0C3BA46422DDFAC05D27C32CECE0B'
...
_lr_productions = [
  ...
  ('program -> errorProgram PROGRAM saveType ID saveProc { opVars changeCurrentScope opFunctions main } printTables','program',12,'p_program','CT.py',210),
  ('changeCurrentScope -> <empty>','changeCurrentScope',0,'p_changeCurrentScope','CT.py',214),
  ('saveType -> <empty>','saveType',0,'p_saveType','CT.py',219),
  ('saveProc -> <empty>','saveProc',0,'p_saveProc','CT.py',226),
  ('errorProgram -> <empty>','errorProgram',0,'p_errorProgram','CT.py',243),
  ('opVars -> vars','opVars',1,'p_opVars','CT.py',249),
  ('opVars -> empty','opVars',1,'p_opVars','CT.py',250),
  ('opFunctions -> function opFunctions','opFunctions',2,'p_opFunctions','CT.py',255),
  ('opFunctions -> empty','opFunctions',1,'p_opFunctions','CT.py',256),
  ('vars -> errorVars VARS declare','vars',3,'p_vars','CT.py',260),
  ('saveID -> <empty>','saveID',0,'p_saveID','CT.py',265),
  ('errorVars -> <empty>','errorVars',0,'p_errorVars','CT.py',294),
  ('type -> errorType INT','type',2,'p_type','CT.py',300),
  ('type -> FLOAT','type',1,'p_type','CT.py',301),
  ('type -> STRING','type',1,'p_type','CT.py',302),
  ('type -> BOOL','type',1,'p_type','CT.py',303),
  ('errorType -> <empty>','errorType',0,'p_errorType','CT.py',308),
  ('main -> errorMain MAIN saveMain { opVars body } clearVarsTable','main',8,'p_main','CT.py',314),
  ('saveMain -> <empty>','saveMain',0,'p_saveMain','CT.py',318),
  ('errorMain -> <empty>','errorMain',0,'p_errorMain','CT.py',326),
  ('instr -> basicStatements ;','instr',2,'p_instr','CT.py',332),
  ('instr -> condition','instr',1,'p_instr','CT.py',333),
  ('instr -> cycle','instr',1,'p_instr','CT.py',334),
  ('basicStatements -> assign','basicStatements',1,'p_basicStatements','CT.py',338),
  ('basicStatements -> funcCall','basicStatements',1,'p_basicStatements','CT.py',339),
  ('declare -> basicDeclare','declare',1,'p_declare','CT.py',343),
  ('declare -> structDeclare','declare',1,'p_declare','CT.py',344),
  ('declare -> dictDeclare','declare',1,'p_declare','CT.py',345),
  ('init -> ASGN initWith errorInit','init',3,'p_init','CT.py',350),
  ('errorInit -> <empty>','errorInit',0,'p_errorInit','CT.py',355),
  ('initWith -> expresion','initWith',1,'p_initWith','CT.py',361),
  ('initWith -> funcCall','initWith',1,'p_initWith','CT.py',362),
  ('initDict -> ASGN ( dictType : dictType ) errorInitDict','initDict',7,'p_initDict','CT.py',367),
  ('errorInitDict -> <empty>','errorInitDict',0,'p_errorInitDict','CT.py',372),
  ('dictType -> errorDictType CTES','dictType',2,'p_dictType','CT.py',378),
  ('dictType -> cte','dictType',1,'p_dictType','CT.py',379),
  ('dictType -> ID','dictType',1,'p_dictType','CT.py',380),
  ('errorDictType -> <empty>','errorDictType',0,'p_errorDictType','CT.py',385),
  ('param -> saveType type errorParam ID cyTypeParam cyParam','param',6,'p_param','CT.py',391),
  ('errorParam -> <empty>','errorParam',0,'p_errorParam','CT.py',396),
  ('cyParam -> errorCyParam saveID saveTypeParam ; param','cyParam',5,'p_cyParam','CT.py',402),
  ('cyParam -> empty saveID saveTypeParam','cyParam',3,'p_cyParam','CT.py',403),
  ('cyTypeParam -> , saveID saveTypeParam ID cyTypeParam','cyTypeParam',5,'p_cyTypeParam','CT.py',408),
  ('cyTypeParam -> empty','cyTypeParam',1,'p_cyTypeParam','CT.py',409),
  ('saveTypeParam -> <empty>','saveTypeParam',0,'p_saveTypeParam','CT.py',413),
  ('errorCyParam -> <empty>','errorCyParam',0,'p_errorCyParam','CT.py',422),
  ('function -> errorFunction FUNC saveType ID saveProc flagParameters ( opParameters ) flagParameters opReturns } clearVarsTable','function',13,'p_function','CT.py',428),
  ('errorFunction -> <empty>','errorFunction',0,'p_errorFunction','CT.py',432),
  ('clearVarsTable -> <empty>','clearVarsTable',0,'p_clearVarsTable','CT.py',437),
  ('return -> errorReturn RETURN expresion ;','return',4,'p_return','CT.py',448),
  ('errorReturn -> <empty>','errorReturn',0,'p_errorReturn','CT.py',453),
  ('opParameters -> param saveParamToDirProc errorOpParameters','opParameters',3,'p_opParameters','CT.py',459),
  ('opParameters -> empty','opParameters',1,'p_opParameters','CT.py',460),
  ('flagParameters -> <empty>','flagParameters',0,'p_flagParameters','CT.py',464),
  ('saveParamToDirProc -> <empty>','saveParamToDirProc',0,'p_saveParamToDirProc','CT.py',469),
  ('errorOpParameters -> <empty>','errorOpParameters',0,'p_errorOpParameters','CT.py',477),
  ('opReturns -> errorOpReturns RETURNS type saveReturnType { opVars body return','opReturns',8,'p_opReturns','CT.py',483),
  ('opReturns -> { opVars body','opReturns',3,'p_opReturns','CT.py',484),
  ('saveReturnType -> <empty>','saveReturnType',0,'p_saveReturnType','CT.py',489),
  ('errorOpReturns -> <empty>','errorOpReturns',0,'p_errorOpReturns','CT.py',495),
  ('basicDeclare -> saveType type errorBasicDeclare ID cyTypeParam saveID ; cyDeclare','basicDeclare',8,'p_basicDeclare','CT.py',501),
  ('errorBasicDeclare -> <empty>','errorBasicDeclare',0,'p_errorBasicDeclare','CT.py',506),
  ('structDeclare -> errorStructDeclare STRUCT ID struct ; cyDeclare','structDeclare',6,'p_structDeclare','CT.py',512),
  ('errorStructDeclare -> <empty>','errorStructDeclare',0,'p_errorStructDeclare','CT.py',517),
  ('dictDeclare -> errorDictDeclare DICT ID dict ; cyDeclare','dictDeclare',6,'p_dictDeclare','CT.py',523),
  ('errorDictDeclare -> <empty>','errorDictDeclare',0,'p_errorDictDeclare','CT.py',528),
  ('cyDeclare -> declare','cyDeclare',1,'p_cyDeclare','CT.py',534),
  ('cyDeclare -> empty','cyDeclare',1,'p_cyDeclare','CT.py',535),
  ('body -> errorBody cyInstruction','body',2,'p_body','CT.py',540),
  ('body -> empty','body',1,'p_body','CT.py',541),
  ('errorBody -> <empty>','errorBody',0,'p_errorBody','CT.py',546),
  ('cyInstruction -> instr body','cyInstruction',2,'p_cyInstruction','CT.py',552),
  ('cycle -> forCycle','cycle',1,'p_cycle','CT.py',557),
  ('cycle -> whileCycle','cycle',1,'p_cycle','CT.py',558),
  ('whileCycle -> errorWhileCycle WHILE ( expresion ) { body }','whileCycle',8,'p_whileCycle','CT.py',563),
  ('errorWhileCycle -> <empty>','errorWhileCycle',0,'p_errorWhileCycle','CT.py',568),
  ('forCycle -> errorForCycle FOR ( assign ; expresion ; assign ) { body }','forCycle',12,'p_forCycle','CT.py',574),
  ('errorForCycle -> <empty>','errorForCycle',0,'p_errorForCycle','CT.py',579),
  ('assign -> ID errorAssign assignOptions','assign',3,'p_assign','CT.py',585),
  ('errorAssign -> <empty>','errorAssign',0,'p_errorAssign','CT.py',590),
  ('assignOptions -> init','assignOptions',1,'p_assignOptions','CT.py',596),
  ('assignOptions -> initDict','assignOptions',1,'p_assignOptions','CT.py',597),
  ('assignOptions -> [ expresion ] assignMatrix init','assignOptions',5,'p_assignOptions','CT.py',598),
  ('assignMatrix -> [ expresion ] errorAssignMatrix','assignMatrix',4,'p_assignMatrix','CT.py',603),
  ('assignMatrix -> empty','assignMatrix',1,'p_assignMatrix','CT.py',604),
  ('errorAssignMatrix -> <empty>','errorAssignMatrix',0,'p_errorAssignMatrix','CT.py',609),
  ('funcCall -> ID ( opParamCall )','funcCall',4,'p_funcCall','CT.py',615),
  ('opParamCall -> expresion cyParamCall','opParamCall',2,'p_opParamCall','CT.py',620),
  ('opParamCall -> empty','opParamCall',1,'p_opParamCall','CT.py',621),
  ('cyParamCall -> , expresion cyParamCall','cyParamCall',3,'p_cyParamCall','CT.py',626),
  ('cyParamCall -> empty','cyParamCall',1,'p_cyParamCall','CT.py',627),
  ('struct -> structType [ CTED ] optionalMatrix','struct',5,'p_struct','CT.py',632),
  ('structType -> type','structType',1,'p_structType','CT.py',637),
  ('structType -> DICT dict','structType',2,'p_structType','CT.py',638),
  ('optionalMatrix -> [ CTED ]','optionalMatrix',3,'p_optionalMatrix','CT.py',643),
  ('optionalMatrix -> empty','optionalMatrix',1,'p_optionalMatrix','CT.py',644),
  ('condition -> errorCondition IF ( expresion ) { body } optionalElse','condition',9,'p_condition','CT.py',649),
  ('errorCondition -> <empty>','errorCondition',0,'p_errorCondition','CT.py',654),
  ('optionalElse -> errorElse ELSE { body }','optionalElse',5,'p_optionalElse','CT.py',660),
  ('optionalElse -> empty','optionalElse',1,'p_optionalElse','CT.py',661),
  ('errorElse -> <empty>','errorElse',0,'p_errorElse','CT.py',666),
  ('dict -> errorDict ( type : type )','dict',6,'p_dict','CT.py',672),
  ('errorDict -> <empty>','errorDict',0,'p_errorDict','CT.py',677),
  ('expresion -> sExp cyExpresion errorExpresion','expresion',3,'p_expresion','CT.py',683),
  ('errorExpresion -> <empty>','errorExpresion',0,'p_errorExpresion','CT.py',688),
  ('cyExpresion -> AND expresion','cyExpresion',2,'p_cyExpresion','CT.py',694),
  ('cyExpresion -> OR expresion','cyExpresion',2,'p_cyExpresion','CT.py',695),
  ('cyExpresion -> empty','cyExpresion',1,'p_cyExpresion','CT.py',696),
  ('sExp -> exp errorOpSExp opSExp','sExp',3,'p_sExp','CT.py',701),
  ('opSExp -> prueba EQ exp','opSExp',3,'p_opSExp','CT.py',706),
  ('opSExp -> prueba DIF exp','opSExp',3,'p_opSExp','CT.py',707),
  ('opSExp -> prueba LTOEQ exp','opSExp',3,'p_opSExp','CT.py',708),
  ('opSExp -> prueba GTOEQ exp','opSExp',3,'p_opSExp','CT.py',709),
  ('opSExp -> prueba GT exp','opSExp',3,'p_opSExp','CT.py',710),
  ('opSExp -> prueba LT exp','opSExp',3,'p_opSExp','CT.py',711),
  ('opSExp -> empty','opSExp',1,'p_opSExp','CT.py',712),
  ('prueba -> <empty>','prueba',0,'p_prueba','CT.py',716),
  ('errorOpSExp -> <empty>','errorOpSExp',0,'p_errorOpSExp','CT.py',722),
  ('exp -> term errorCyExp cyExp','exp',3,'p_exp','CT.py',728),
  ('cyExp -> PLUS term','cyExp',2,'p_cyExp','CT.py',733),
  ('cyExp -> MINUS term','cyExp',2,'p_cyExp','CT.py',734),
  ('cyExp -> empty','cyExp',1,'p_cyExp','CT.py',735),
  ('errorCyExp -> <empty>','errorCyExp',0,'p_errorCyExp','CT.py',740),
  ('term -> fact cyTerm','term',2,'p_term','CT.py',746),
  ('cyTerm -> MULT errorFact fact','cyTerm',3,'p_cyTerm','CT.py',751),
  ('cyTerm -> DIV fact','cyTerm',2,'p_cyTerm','CT.py',752),
  ('cyTerm -> empty','cyTerm',1,'p_cyTerm','CT.py',753),
  ('fact -> CTES','fact',1,'p_fact','CT.py',758),
  ('fact -> cte','fact',1,'p_fact','CT.py',759),
  ('fact -> funcCall','fact',1,'p_fact','CT.py',760),
  ('fact -> ( expresion )','fact',3,'p_fact','CT.py',761),
  ('fact -> ID opAccess errorOpAccess','fact',3,'p_fact','CT.py',762),
  ('errorFact -> <empty>','errorFact',0,'p_errorFact','CT.py',767),
  ('opAccess -> opStruct','opAccess',1,'p_opAccess','CT.py',773),
  ('opAccess -> opDictionary','opAccess',1,'p_opAccess','CT.py',774),
  ('opAccess -> empty','opAccess',1,'p_opAccess','CT.py',775),
  ('errorOpAccess -> <empty>','errorOpAccess',0,'p_errorOpAccess','CT.py',780),
  ('opStruct -> errorOpStruct [ expresion ] opMatrix','opStruct',5,'p_opStruct','CT.py',786),
  ('errorOpStruct -> <empty>','errorOpStruct',0,'p_errorOpStruct','CT.py',791),
  ('opMatrix -> errorOpMatrix [ expresion ]','opMatrix',4,'p_opMatrix','CT.py',797),
  ('opMatrix -> empty','opMatrix',1,'p_opMatrix','CT.py',798),
  ('errorOpMatrix -> <empty>','errorOpMatrix',0,'p_errorOpMatrix','CT.py',803),
  ('opDictionary -> . dictIndex','opDictionary',2,'p_opDictionary','CT.py',809),
  ('dictIndex -> FIRST','dictIndex',1,'p_dictIndex','CT.py',814),
  ('dictIndex -> LAST','dictIndex',1,'p_dictIndex','CT.py',815),
  ('cte -> CTED','cte',1,'p_cte','CT.py',820),
  ('cte -> CTEF','cte',1,'p_cte','CT.py',821),
  ('cte -> TRUE','cte',1,'p_cte','CT.py',822),
  ('cte -> FALSE','cte',1,'p_cte','CT.py',823),
  ('empty -> <empty>','empty',0,'p_empty','CT.py',828),
  ('printTables -> <empty>','printTables',0,'p_printTables','CT.py',833),
]
