...
_lr_productions = [
  ...
  ('errorVars -> <empty>','errorVars',0,'p_errorVars','CT.py',391),
  ('type -> errorType INT','type',2,'p_type','CT.py',397),
  ('type -> FLOAT','type',1,'p_type','CT.py',398),
  ('type -> STRING','type',1,'p_type','CT.py',399),
  ('type -> BOOL','type',1,'p_type','CT.py',400),
  ('errorType -> <empty>','errorType',0,'p_errorType','CT.py',405),
  ('main -> errorMain MAIN saveMain { opVars body } clearVarsTable','main',8,'p_main','CT.py',411),
  ('saveMain -> <empty>','saveMain',0,'p_saveMain','CT.py',415),
  ('errorMain -> <empty>','errorMain',0,'p_errorMain','CT.py',423),
  ('instr -> basicStatements ;','instr',2,'p_instr','CT.py',429),
  ('instr -> condition','instr',1,'p_instr','CT.py',430),
  ('instr -> cycle','instr',1,'p_instr','CT.py',431),
  ('basicStatements -> assign','basicStatements',1,'p_basicStatements','CT.py',435),
  ('basicStatements -> funcCall','basicStatements',1,'p_basicStatements','CT.py',436),
  ('basicStatements -> print','basicStatements',1,'p_basicStatements','CT.py',437),
  ('basicStatements -> read','basicStatements',1,'p_basicStatements','CT.py',438),
  ('print -> PRINT PARINI exp performPrint cyPrint PARFIN','print',6,'p_print','CT.py',441),
  ('cyPrint -> , fix exp performPrint cyPrint','cyPrint',5,'p_cyPrint','CT.py',444),
  ('cyPrint -> empty','cyPrint',1,'p_cyPrint','CT.py',445),
  ('read -> READ PARINI ID performRead cyRead PARFIN','read',6,'p_read','CT.py',448),
  ('cyRead -> , fix ID performRead cyRead','cyRead',5,'p_cyRead','CT.py',451),
  ('cyRead -> empty','cyRead',1,'p_cyRead','CT.py',452),
  ('fix -> <empty>','fix',0,'p_fix','CT.py',455),
  ('declare -> basicDeclare','declare',1,'p_declare','CT.py',460),
  ('declare -> structDeclare','declare',1,'p_declare','CT.py',461),
  ('declare -> dictDeclare','declare',1,'p_declare','CT.py',462),
  ('init -> ASGN saveOperator errorInit initWith','init',4,'p_init','CT.py',467),
  ('errorInit -> <empty>','errorInit',0,'p_errorInit','CT.py',471),
  ('initWith -> expresion','initWith',1,'p_initWith','CT.py',477),
  ('initWith -> funcCall','initWith',1,'p_initWith','CT.py',478),
  ('initDict -> ASGN PARINI dictType : dictType PARFIN errorInitDict','initDict',7,'p_initDict','CT.py',483),
  ('errorInitDict -> <empty>','errorInitDict',0,'p_errorInitDict','CT.py',488),
  ('dictType -> errorDictType CTES','dictType',2,'p_dictType','CT.py',494),
  ('dictType -> cte','dictType',1,'p_dictType','CT.py',495),
  ('dictType -> ID','dictType',1,'p_dictType','CT.py',496),
  ('errorDictType -> <empty>','errorDictType',0,'p_errorDictType','CT.py',501),
  ('param -> saveType type errorParam ID cyTypeParam cyParam','param',6,'p_param','CT.py',507),
  ('errorParam -> <empty>','errorParam',0,'p_errorParam','CT.py',512),
  ('cyParam -> errorCyParam saveID saveTypeParam ; param','cyParam',5,'p_cyParam','CT.py',518),
  ('cyParam -> empty saveID saveTypeParam','cyParam',3,'p_cyParam','CT.py',519),
  ('cyTypeParam -> , saveID saveTypeParam ID cyTypeParam','cyTypeParam',5,'p_cyTypeParam','CT.py',524),
  ('cyTypeParam -> empty','cyTypeParam',1,'p_cyTypeParam','CT.py',525),
  ('saveTypeParam -> <empty>','saveTypeParam',0,'p_saveTypeParam','CT.py',529),
  ('errorCyParam -> <empty>','errorCyParam',0,'p_errorCyParam','CT.py',539),
  ('function -> errorFunction FUNC saveType ID saveProc flagParameters PARINI opParameters PARFIN flagParameters opReturns } clearVarsTable','function',13,'p_function','CT.py',545),
  ('errorFunction -> <empty>','errorFunction',0,'p_errorFunction','CT.py',549),
  ('clearVarsTable -> <empty>','clearVarsTable',0,'p_clearVarsTable','CT.py',554),
  ('return -> errorReturn RETURN expresion ;','return',4,'p_return','CT.py',560),
  ('errorReturn -> <empty>','errorReturn',0,'p_errorReturn','CT.py',565),
  ('opParameters -> param saveParamToDirProc errorOpParameters','opParameters',3,'p_opParameters','CT.py',571),
  ('opParameters -> empty','opParameters',1,'p_opParameters','CT.py',572),
  ('flagParameters -> <empty>','flagParameters',0,'p_flagParameters','CT.py',576),
  ('saveParamToDirProc -> <empty>','saveParamToDirProc',0,'p_saveParamToDirProc','CT.py',581),
  ('errorOpParameters -> <empty>','errorOpParameters',0,'p_errorOpParameters','CT.py',589),
  ('opReturns -> errorOpReturns RETURNS type saveReturnType { opVars body return','opReturns',8,'p_opReturns','CT.py',595),
  ('opReturns -> { opVars body','opReturns',3,'p_opReturns','CT.py',596),
  ('saveReturnType -> <empty>','saveReturnType',0,'p_saveReturnType','CT.py',601),
  ('errorOpReturns -> <empty>','errorOpReturns',0,'p_errorOpReturns','CT.py',607),
  ('basicDeclare -> saveType type errorBasicDeclare ID cyTypeParam saveID ; cyDeclare','basicDeclare',8,'p_basicDeclare','CT.py',613),
  ('errorBasicDeclare -> <empty>','errorBasicDeclare',0,'p_errorBasicDeclare','CT.py',618),
  ('structDeclare -> errorStructDeclare STRUCT ID struct ; cyDeclare','structDeclare',6,'p_structDeclare','CT.py',624),
  ('errorStructDeclare -> <empty>','errorStructDeclare',0,'p_errorStructDeclare','CT.py',629),
  ('dictDeclare -> errorDictDeclare DICT ID dict ; cyDeclare','dictDeclare',6,'p_dictDeclare','CT.py',635),
  ('errorDictDeclare -> <empty>','errorDictDeclare',0,'p_errorDictDeclare','CT.py',640),
  ('cyDeclare -> declare','cyDeclare',1,'p_cyDeclare','CT.py',646),
  ('cyDeclare -> empty','cyDeclare',1,'p_cyDeclare','CT.py',647),
  ('body -> errorBody cyInstruction','body',2,'p_body','CT.py',652),
  ('body -> empty','body',1,'p_body','CT.py',653),
  ('errorBody -> <empty>','errorBody',0,'p_errorBody','CT.py',658),
  ('cyInstruction -> instr body','cyInstruction',2,'p_cyInstruction','CT.py',664),
  ('cycle -> forCycle','cycle',1,'p_cycle','CT.py',669),
  ('cycle -> whileCycle','cycle',1,'p_cycle','CT.py',670),
  ('whileCycle -> errorWhileCycle WHILE saveReturn PARINI expresion PARFIN saveFalso { body } repeatWhile','whileCycle',11,'p_whileCycle','CT.py',675),
  ('repeatWhile -> <empty>','repeatWhile',0,'p_repeatWhile','CT.py',679),
  ('saveReturn -> <empty>','saveReturn',0,'p_saveReturn','CT.py',686),
  ('errorWhileCycle -> <empty>','errorWhileCycle',0,'p_errorWhileCycle','CT.py',690),
  ('forCycle -> errorForCycle FOR PARINI assign ; saveReturn expresion saveFalso ; saltoBody assign returnFor PARFIN { rellenaBody body } returnAssign','forCycle',18,'p_forCycle','CT.py',696),
  ('saltoBody -> <empty>','saltoBody',0,'p_saltoBody','CT.py',700),
  ('returnFor -> <empty>','returnFor',0,'p_returnFor','CT.py',706),
  ('rellenaBody -> <empty>','rellenaBody',0,'p_rellenaBody','CT.py',718),
  ('returnAssign -> <empty>','returnAssign',0,'p_returnAssign','CT.py',726),
  ('errorForCycle -> <empty>','errorForCycle',0,'p_errorForCycle','CT.py',731),
  ('assign -> ID saveVariable errorAssign assignOptions performAssign','assign',5,'p_assign','CT.py',737),
  ('errorAssign -> <empty>','errorAssign',0,'p_errorAssign','CT.py',742),
  ('assignOptions -> init','assignOptions',1,'p_assignOptions','CT.py',748),
  ('assignOptions -> initDict','assignOptions',1,'p_assignOptions','CT.py',749),
  ('assignOptions -> [ expresion ] assignMatrix init','assignOptions',5,'p_assignOptions','CT.py',750),
  ('assignMatrix -> [ expresion ] errorAssignMatrix','assignMatrix',4,'p_assignMatrix','CT.py',755),
  ('assignMatrix -> empty','assignMatrix',1,'p_assignMatrix','CT.py',756),
  ('errorAssignMatrix -> <empty>','errorAssignMatrix',0,'p_errorAssignMatrix','CT.py',761),
  ('funcCall -> ID PARINI opParamCall PARFIN','funcCall',4,'p_funcCall','CT.py',767),
  ('opParamCall -> expresion cyParamCall','opParamCall',2,'p_opParamCall','CT.py',772),
  ('opParamCall -> empty','opParamCall',1,'p_opParamCall','CT.py',773),
  ('cyParamCall -> , expresion cyParamCall','cyParamCall',3,'p_cyParamCall','CT.py',778),
  ('cyParamCall -> empty','cyParamCall',1,'p_cyParamCall','CT.py',779),
  ('struct -> structType [ CTED ] optionalMatrix','struct',5,'p_struct','CT.py',784),
  ('structType -> type','structType',1,'p_structType','CT.py',789),
  ('structType -> DICT dict','structType',2,'p_structType','CT.py',790),
  ('optionalMatrix -> [ CTED ]','optionalMatrix',3,'p_optionalMatrix','CT.py',795),
  ('optionalMatrix -> empty','optionalMatrix',1,'p_optionalMatrix','CT.py',796),
  ('condition -> errorCondition IF PARINI expresion PARFIN saveFalso { body } optionalElse rellenaFalso','condition',11,'p_condition','CT.py',801),
  ('errorCondition -> <empty>','errorCondition',0,'p_errorCondition','CT.py',806),
  ('optionalElse -> errorElse ELSE saveVerdadero { body }','optionalElse',6,'p_optionalElse','CT.py',812),
  ('optionalElse -> empty','optionalElse',1,'p_optionalElse','CT.py',813),
  ('errorElse -> <empty>','errorElse',0,'p_errorElse','CT.py',818),
  ('dict -> errorDict PARINI type : type PARFIN','dict',6,'p_dict','CT.py',824),
  ('errorDict -> <empty>','errorDict',0,'p_errorDict','CT.py',829),
  ('expresion -> sExp performAndOr cyExpresion errorExpresion','expresion',4,'p_expresion','CT.py',835),
  ('errorExpresion -> <empty>','errorExpresion',0,'p_errorExpresion','CT.py',841),
  ('cyExpresion -> AND saveOperator expresion','cyExpresion',3,'p_cyExpresion','CT.py',847),
  ('cyExpresion -> OR saveOperator expresion','cyExpresion',3,'p_cyExpresion','CT.py',848),
  ('cyExpresion -> empty','cyExpresion',1,'p_cyExpresion','CT.py',849),
  ('sExp -> exp errorOpSExp opSExp performRelational','sExp',4,'p_sExp','CT.py',854),
  ('opSExp -> EQ saveOperator exp','opSExp',3,'p_opSExp','CT.py',859),
  ('opSExp -> DIF saveOperator exp','opSExp',3,'p_opSExp','CT.py',860),
  ('opSExp -> LTOEQ saveOperator exp','opSExp',3,'p_opSExp','CT.py',861),
  ('opSExp -> GTOEQ saveOperator exp','opSExp',3,'p_opSExp','CT.py',862),
  ('opSExp -> GT saveOperator exp','opSExp',3,'p_opSExp','CT.py',863),
  ('opSExp -> LT saveOperator exp','opSExp',3,'p_opSExp','CT.py',864),
  ('opSExp -> empty','opSExp',1,'p_opSExp','CT.py',865),
  ('errorOpSExp -> <empty>','errorOpSExp',0,'p_errorOpSExp','CT.py',869),
  ('exp -> term performAddSub errorCyExp cyExp','exp',4,'p_exp','CT.py',875),
  ('cyExp -> PLUS saveOperator exp','cyExp',3,'p_cyExp','CT.py',880),
  ('cyExp -> MINUS saveOperator exp','cyExp',3,'p_cyExp','CT.py',881),
  ('cyExp -> empty','cyExp',1,'p_cyExp','CT.py',882),
  ('errorCyExp -> <empty>','errorCyExp',0,'p_errorCyExp','CT.py',887),
  ('term -> fact performMulDiv cyTerm','term',3,'p_term','CT.py',892),
  ('cyTerm -> MULT saveOperator errorFact term','cyTerm',4,'p_cyTerm','CT.py',897),
  ('cyTerm -> DIV saveOperator term','cyTerm',3,'p_cyTerm','CT.py',898),
  ('cyTerm -> empty','cyTerm',1,'p_cyTerm','CT.py',899),
  ('fact -> CTES saveConstantString','fact',2,'p_fact','CT.py',904),
  ('fact -> cte','fact',1,'p_fact','CT.py',905),
  ('fact -> funcCall','fact',1,'p_fact','CT.py',906),
  ('fact -> PARINI putFondo expresion PARFIN takeFondo','fact',5,'p_fact','CT.py',907),
  ('fact -> ID saveVariable opAccess errorOpAccess','fact',4,'p_fact','CT.py',908),
  ('errorFact -> <empty>','errorFact',0,'p_errorFact','CT.py',913),
  ('opAccess -> opStruct','opAccess',1,'p_opAccess','CT.py',919),
  ('opAccess -> opDictionary','opAccess',1,'p_opAccess','CT.py',920),
  ('opAccess -> empty','opAccess',1,'p_opAccess','CT.py',921),
  ('errorOpAccess -> <empty>','errorOpAccess',0,'p_errorOpAccess','CT.py',926),
  ('opStruct -> errorOpStruct [ expresion ] opMatrix','opStruct',5,'p_opStruct','CT.py',931),
  ('errorOpStruct -> <empty>','errorOpStruct',0,'p_errorOpStruct','CT.py',936),
  ('opMatrix -> errorOpMatrix [ expresion ]','opMatrix',4,'p_opMatrix','CT.py',942),
  ('opMatrix -> empty','opMatrix',1,'p_opMatrix','CT.py',943),
  ('errorOpMatrix -> <empty>','errorOpMatrix',0,'p_errorOpMatrix','CT.py',948),
  ('opDictionary -> . dictIndex','opDictionary',2,'p_opDictionary','CT.py',954),
  ('dictIndex -> FIRST','dictIndex',1,'p_dictIndex','CT.py',959),
  ('dictIndex -> LAST','dictIndex',1,'p_dictIndex','CT.py',960),
  ('cte -> CTED saveConstantInt','cte',2,'p_cte','CT.py',965),
  ('cte -> CTEF saveConstantFloat','cte',2,'p_cte','CT.py',966),
  ('cte -> TRUE saveConstantBool','cte',2,'p_cte','CT.py',967),
  ('cte -> FALSE saveConstantBool','cte',2,'p_cte','CT.py',968),
  ('empty -> <empty>','empty',0,'p_empty','CT.py',972),
  ('printTables -> <empty>','printTables',0,'p_printTables','CT.py',977),
  ('rellenaFalso -> <empty>','rellenaFalso',0,'p_rellenaFalso','CT.py',992),
  ('saveFalso -> <empty>','saveFalso',0,'p_saveFalso','CT.py',997),
  ('saveVerdadero -> <empty>','saveVerdadero',0,'p_saveVerdadero','CT.py',1010),
  ('saveConstantInt -> <empty>','saveConstantInt',0,'p_saveConstantInt','CT.py',1017),
  ('saveConstantFloat -> <empty>','saveConstantFloat',0,'p_saveConstantFloat','CT.py',1024),
  ('saveConstantBool -> <empty>','saveConstantBool',0,'p_saveConstantBool','CT.py',1031),
  ('saveConstantString -> <empty>','saveConstantString',0,'p_saveConstantString','CT.py',1038),
  ('saveVariable -> <empty>','saveVariable',0,'p_saveVariable','CT.py',1045),
  ('saveOperator -> <empty>','saveOperator',0,'p_saveOperator','CT.py',1068),
  ('putFondo -> <empty>','putFondo',0,'p_putFondo','CT.py',1098),
  ('takeFondo -> <empty>','takeFondo',0,'p_takeFondo','CT.py',1103),
  ('performAssign -> <empty>','performAssign',0,'p_performAssign','CT.py',1110),
  ('performMulDiv -> <empty>','performMulDiv',0,'p_performMulDiv','CT.py',1131),
  ('performAddSub -> <empty>','performAddSub',0,'p_performAddSub','CT.py',1152),
  ('performRelational -> <empty>','performRelational',0,'p_performRelational','CT.py',1173),
  ('performAndOr -> <empty>','performAndOr',0,'p_performAndOr','CT.py',1194),
  ('performPrint -> <empty>','performPrint',0,'p_performPrint','CT.py',1215),
  ('performRead -> <empty>','performRead',0,'p_performeRead','CT.py',1219),
]
