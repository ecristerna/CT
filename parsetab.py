...
_lr_signature = 'E77C9761CFB904E3620CD2D02BC03354'
...
_lr_productions = [
  ...
  ('program -> errorProgram PROGRAM saveType ID saveProc { opVars changeCurrentScope opFunctions main } printTables','program',12,'p_program','CT.py',81),
  ...
  ('errorProgram -> <empty>','errorProgram',0,'p_errorProgram','CT.py',115),
  ('opVars -> vars','opVars',1,'p_opVars','CT.py',121),
  ('opVars -> empty','opVars',1,'p_opVars','CT.py',122),
  ('opFunctions -> function opFunctions','opFunctions',2,'p_opFunctions','CT.py',127),
  ('opFunctions -> empty','opFunctions',1,'p_opFunctions','CT.py',128),
  ('vars -> errorVars VARS declare','vars',3,'p_vars','CT.py',132),
  ('saveID -> <empty>','saveID',0,'p_saveID','CT.py',137),
  ('errorVars -> <empty>','errorVars',0,'p_errorVars','CT.py',166),
  ('type -> errorType INT','type',2,'p_type','CT.py',172),
  ('type -> FLOAT','type',1,'p_type','CT.py',173),
  ('type -> STRING','type',1,'p_type','CT.py',174),
  ('type -> OBJECT','type',1,'p_type','CT.py',175),
  ('type -> BOOL','type',1,'p_type','CT.py',176),
  ('errorType -> <empty>','errorType',0,'p_errorType','CT.py',181),
  ('main -> errorMain MAIN saveMain { opVars body } clearVarsTable','main',8,'p_main','CT.py',187),
  ('saveMain -> <empty>','saveMain',0,'p_saveMain','CT.py',191),
  ('errorMain -> <empty>','errorMain',0,'p_errorMain','CT.py',199),
  ('instr -> basicStatements ;','instr',2,'p_instr','CT.py',205),
  ('instr -> condition','instr',1,'p_instr','CT.py',206),
  ('instr -> cycle','instr',1,'p_instr','CT.py',207),
  ('basicStatements -> assign','basicStatements',1,'p_basicStatements','CT.py',211),
  ('basicStatements -> funcCall','basicStatements',1,'p_basicStatements','CT.py',212),
  ('declare -> basicDeclare','declare',1,'p_declare','CT.py',216),
  ('declare -> structDeclare','declare',1,'p_declare','CT.py',217),
  ('declare -> dictDeclare','declare',1,'p_declare','CT.py',218),
  ('init -> = initWith errorInit','init',3,'p_init','CT.py',223),
  ('errorInit -> <empty>','errorInit',0,'p_errorInit','CT.py',228),
  ('initWith -> expresion','initWith',1,'p_initWith','CT.py',234),
  ('initWith -> funcCall','initWith',1,'p_initWith','CT.py',235),
  ('initDict -> = ( dictType : dictType ) errorInitDict','initDict',7,'p_initDict','CT.py',240),
  ('errorInitDict -> <empty>','errorInitDict',0,'p_errorInitDict','CT.py',245),
  ('dictType -> errorDictType CTES','dictType',2,'p_dictType','CT.py',251),
  ('dictType -> cte','dictType',1,'p_dictType','CT.py',252),
  ('dictType -> ID','dictType',1,'p_dictType','CT.py',253),
  ('errorDictType -> <empty>','errorDictType',0,'p_errorDictType','CT.py',258),
  ('param -> saveType type errorParam ID cyTypeParam cyParam','param',6,'p_param','CT.py',264),
  ('errorParam -> <empty>','errorParam',0,'p_errorParam','CT.py',269),
  ('cyParam -> errorCyParam saveID saveTypeParam ; param','cyParam',5,'p_cyParam','CT.py',275),
  ('cyParam -> empty saveID saveTypeParam','cyParam',3,'p_cyParam','CT.py',276),
  ('cyTypeParam -> , saveID saveTypeParam ID cyTypeParam','cyTypeParam',5,'p_cyTypeParam','CT.py',281),
  ('cyTypeParam -> empty','cyTypeParam',1,'p_cyTypeParam','CT.py',282),
  ('saveTypeParam -> <empty>','saveTypeParam',0,'p_saveTypeParam','CT.py',286),
  ('errorCyParam -> <empty>','errorCyParam',0,'p_errorCyParam','CT.py',295),
  ('function -> errorFunction FUNC saveType ID saveProc flagParameters ( opParameters ) flagParameters opReturns } clearVarsTable','function',13,'p_function','CT.py',301),
  ('errorFunction -> <empty>','errorFunction',0,'p_errorFunction','CT.py',305),
  ('clearVarsTable -> <empty>','clearVarsTable',0,'p_clearVarsTable','CT.py',310),
  ('return -> errorReturn RETURN expresion ;','return',4,'p_return','CT.py',321),
  ('errorReturn -> <empty>','errorReturn',0,'p_errorReturn','CT.py',326),
  ('opParameters -> param saveParamToDirProc errorOpParameters','opParameters',3,'p_opParameters','CT.py',332),
  ('opParameters -> empty','opParameters',1,'p_opParameters','CT.py',333),
  ('flagParameters -> <empty>','flagParameters',0,'p_flagParameters','CT.py',337),
  ('saveParamToDirProc -> <empty>','saveParamToDirProc',0,'p_saveParamToDirProc','CT.py',342),
  ('errorOpParameters -> <empty>','errorOpParameters',0,'p_errorOpParameters','CT.py',350),
  ('opReturns -> errorOpReturns RETURNS type saveReturnType { opVars body return','opReturns',8,'p_opReturns','CT.py',356),
  ('opReturns -> { opVars body','opReturns',3,'p_opReturns','CT.py',357),
  ('saveReturnType -> <empty>','saveReturnType',0,'p_saveReturnType','CT.py',362),
  ('errorOpReturns -> <empty>','errorOpReturns',0,'p_errorOpReturns','CT.py',368),
  ('basicDeclare -> saveType type errorBasicDeclare ID cyTypeParam saveID ; cyDeclare','basicDeclare',8,'p_basicDeclare','CT.py',374),
  ('errorBasicDeclare -> <empty>','errorBasicDeclare',0,'p_errorBasicDeclare','CT.py',379),
  ('structDeclare -> errorStructDeclare STRUCT ID struct ; cyDeclare','structDeclare',6,'p_structDeclare','CT.py',385),
  ('errorStructDeclare -> <empty>','errorStructDeclare',0,'p_errorStructDeclare','CT.py',390),
  ('dictDeclare -> errorDictDeclare DICT ID dict ; cyDeclare','dictDeclare',6,'p_dictDeclare','CT.py',396),
  ('errorDictDeclare -> <empty>','errorDictDeclare',0,'p_errorDictDeclare','CT.py',401),
  ('cyDeclare -> declare','cyDeclare',1,'p_cyDeclare','CT.py',407),
  ('cyDeclare -> empty','cyDeclare',1,'p_cyDeclare','CT.py',408),
  ('body -> errorBody cyInstruction','body',2,'p_body','CT.py',413),
  ('body -> empty','body',1,'p_body','CT.py',414),
  ('errorBody -> <empty>','errorBody',0,'p_errorBody','CT.py',419),
  ('cyInstruction -> instr body','cyInstruction',2,'p_cyInstruction','CT.py',425),
  ('cycle -> forCycle','cycle',1,'p_cycle','CT.py',430),
  ('cycle -> whileCycle','cycle',1,'p_cycle','CT.py',431),
  ('whileCycle -> errorWhileCycle WHILE ( expresion ) { body }','whileCycle',8,'p_whileCycle','CT.py',436),
  ('errorWhileCycle -> <empty>','errorWhileCycle',0,'p_errorWhileCycle','CT.py',441),
  ('forCycle -> errorForCycle FOR ( assign ; expresion ; assign ) { body }','forCycle',12,'p_forCycle','CT.py',447),
  ('errorForCycle -> <empty>','errorForCycle',0,'p_errorForCycle','CT.py',452),
  ('assign -> ID errorAssign assignOptions','assign',3,'p_assign','CT.py',458),
  ('errorAssign -> <empty>','errorAssign',0,'p_errorAssign','CT.py',463),
  ('assignOptions -> init','assignOptions',1,'p_assignOptions','CT.py',469),
  ('assignOptions -> initDict','assignOptions',1,'p_assignOptions','CT.py',470),
  ('assignOptions -> [ expresion ] assignMatrix init','assignOptions',5,'p_assignOptions','CT.py',471),
  ('assignMatrix -> [ expresion ] errorAssignMatrix','assignMatrix',4,'p_assignMatrix','CT.py',476),
  ('assignMatrix -> empty','assignMatrix',1,'p_assignMatrix','CT.py',477),
  ('errorAssignMatrix -> <empty>','errorAssignMatrix',0,'p_errorAssignMatrix','CT.py',482),
  ('funcCall -> ID ( opParamCall )','funcCall',4,'p_funcCall','CT.py',488),
  ('opParamCall -> expresion cyParamCall','opParamCall',2,'p_opParamCall','CT.py',493),
  ('opParamCall -> empty','opParamCall',1,'p_opParamCall','CT.py',494),
  ('cyParamCall -> , expresion cyParamCall','cyParamCall',3,'p_cyParamCall','CT.py',499),
  ('cyParamCall -> empty','cyParamCall',1,'p_cyParamCall','CT.py',500),
  ('struct -> structType [ CTED ] optionalMatrix','struct',5,'p_struct','CT.py',505),
  ('structType -> type','structType',1,'p_structType','CT.py',510),
  ('structType -> DICT dict','structType',2,'p_structType','CT.py',511),
  ('optionalMatrix -> [ CTED ]','optionalMatrix',3,'p_optionalMatrix','CT.py',516),
  ('optionalMatrix -> empty','optionalMatrix',1,'p_optionalMatrix','CT.py',517),
  ('condition -> errorCondition IF ( expresion ) { body } optionalElse','condition',9,'p_condition','CT.py',522),
  ('errorCondition -> <empty>','errorCondition',0,'p_errorCondition','CT.py',527),
  ('optionalElse -> errorElse ELSE { body }','optionalElse',5,'p_optionalElse','CT.py',533),
  ('optionalElse -> empty','optionalElse',1,'p_optionalElse','CT.py',534),
  ('errorElse -> <empty>','errorElse',0,'p_errorElse','CT.py',539),
  ('dict -> errorDict ( type : type )','dict',6,'p_dict','CT.py',545),
  ('errorDict -> <empty>','errorDict',0,'p_errorDict','CT.py',550),
  ('expresion -> sExp cyExpresion errorExpresion','expresion',3,'p_expresion','CT.py',556),
  ('errorExpresion -> <empty>','errorExpresion',0,'p_errorExpresion','CT.py',561),
  ('cyExpresion -> AND expresion','cyExpresion',2,'p_cyExpresion','CT.py',567),
  ('cyExpresion -> OR expresion','cyExpresion',2,'p_cyExpresion','CT.py',568),
  ('cyExpresion -> empty','cyExpresion',1,'p_cyExpresion','CT.py',569),
  ('sExp -> exp errorOpSExp opSExp','sExp',3,'p_sExp','CT.py',574),
  ('opSExp -> EQ exp','opSExp',2,'p_opSExp','CT.py',579),
  ('opSExp -> DIF exp','opSExp',2,'p_opSExp','CT.py',580),
  ('opSExp -> LTOEQ exp','opSExp',2,'p_opSExp','CT.py',581),
  ('opSExp -> GTOEQ exp','opSExp',2,'p_opSExp','CT.py',582),
  ('opSExp -> > exp','opSExp',2,'p_opSExp','CT.py',583),
  ('opSExp -> < exp','opSExp',2,'p_opSExp','CT.py',584),
  ('opSExp -> empty','opSExp',1,'p_opSExp','CT.py',585),
  ('errorOpSExp -> <empty>','errorOpSExp',0,'p_errorOpSExp','CT.py',590),
  ('exp -> term errorCyExp cyExp','exp',3,'p_exp','CT.py',596),
  ('cyExp -> + term','cyExp',2,'p_cyExp','CT.py',601),
  ('cyExp -> - term','cyExp',2,'p_cyExp','CT.py',602),
  ('cyExp -> empty','cyExp',1,'p_cyExp','CT.py',603),
  ('errorCyExp -> <empty>','errorCyExp',0,'p_errorCyExp','CT.py',608),
  ('term -> fact cyTerm','term',2,'p_term','CT.py',614),
  ('cyTerm -> * errorFact fact','cyTerm',3,'p_cyTerm','CT.py',619),
  ('cyTerm -> / fact','cyTerm',2,'p_cyTerm','CT.py',620),
  ('cyTerm -> empty','cyTerm',1,'p_cyTerm','CT.py',621),
  ('fact -> CTES','fact',1,'p_fact','CT.py',626),
  ('fact -> cte','fact',1,'p_fact','CT.py',627),
  ('fact -> funcCall','fact',1,'p_fact','CT.py',628),
  ('fact -> ( expresion )','fact',3,'p_fact','CT.py',629),
  ('fact -> ID opAccess errorOpAccess','fact',3,'p_fact','CT.py',630),
  ('errorFact -> <empty>','errorFact',0,'p_errorFact','CT.py',635),
  ('opAccess -> opStruct','opAccess',1,'p_opAccess','CT.py',641),
  ('opAccess -> opDictionary','opAccess',1,'p_opAccess','CT.py',642),
  ('opAccess -> empty','opAccess',1,'p_opAccess','CT.py',643),
  ('errorOpAccess -> <empty>','errorOpAccess',0,'p_errorOpAccess','CT.py',648),
  ('opStruct -> errorOpStruct [ expresion ] opMatrix','opStruct',5,'p_opStruct','CT.py',654),
  ('errorOpStruct -> <empty>','errorOpStruct',0,'p_errorOpStruct','CT.py',659),
  ('opMatrix -> errorOpMatrix [ expresion ]','opMatrix',4,'p_opMatrix','CT.py',665),
  ('opMatrix -> empty','opMatrix',1,'p_opMatrix','CT.py',666),
  ('errorOpMatrix -> <empty>','errorOpMatrix',0,'p_errorOpMatrix','CT.py',671),
  ('opDictionary -> . dictIndex','opDictionary',2,'p_opDictionary','CT.py',677),
  ('dictIndex -> FIRST','dictIndex',1,'p_dictIndex','CT.py',682),
  ('dictIndex -> LAST','dictIndex',1,'p_dictIndex','CT.py',683),
  ('cte -> CTED','cte',1,'p_cte','CT.py',688),
  ('cte -> CTEF','cte',1,'p_cte','CT.py',689),
  ('cte -> TRUE','cte',1,'p_cte','CT.py',690),
  ('cte -> FALSE','cte',1,'p_cte','CT.py',691),
